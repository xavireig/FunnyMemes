...
import xavireig.com.funnymemes.adapter.FullScreenImageAdapter;
import xavireig.com.funnymemes.helper.Utils;
...
public class FullScreenViewActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        File sdCardDirectory = new File(Environment.getExternalStorageDirectory() + File.separator + "FunnyMemes" + File.separator);
